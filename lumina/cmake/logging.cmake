option(LUMINA_ENABLE_CONSOLE_LOGGING "Enable logging to the console" ON)
option(LUMINA_ENABLE_FILE_LOGGING "Enable logging to the lumina.log file" ON)

if (LUMINA_ENABLE_CONSOLE_LOGGING)
    message(STATUS "Logging to console enabled")
else()
    message(STATUS "Logging to console disabled")
endif()
if (LUMINA_ENABLE_FILE_LOGGING)
...
if (LUMINA_ENABLE_FILE_LOGGING OR LUMINA_ENABLE_CONSOLE_LOGGING)
